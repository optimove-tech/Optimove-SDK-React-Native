...
import type { InAppInboxItem, InAppInboxSummary, OptimoveInAppPresentationResult } from './inApp';
...
export default class Optimove {
    ...
    static reportScreenVisit(screenName: string, screenCategory?: string) {
        return OptimoveReactNative.reportScreenVisit(
            screenName,
            screenCategory
        );
    }
    ...
    static inAppPresentInboxMessage(item: InAppInboxItem): Promise<OptimoveInAppPresentationResult> {
    ...
    static setOnInboxUpdateHandler(inAppInboxUpdatedHandler: InAppInboxUpdatedHandler) {
    ...
    static initOnInboxUpdateSubscriptionIfNeeded() {
        ...
        Optimove.inAppInboxUpdatedSubscription =
            optimoveEmitter.addListener(
    ...
    static initInAppDeeplinkSubscriptionIfNeeded() {
        ...
        Optimove.inAppDeepLinkSubscription =
            optimoveEmitter.addListener(
